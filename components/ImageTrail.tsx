...
class ImageTrailVariant1 {
  ...
  private showNextImage() {
    ...
    const filename = img.DOM.el.querySelector('.filename');

    gsap.killTweensOf(img.DOM.el);
    gsap.killTweensOf(filename);
    ...
    gsap
      ...
      .fromTo(filename, { opacity: 0 }, { duration: 0.4, opacity: 1 }, 0)
      .to(filename, { duration: 0.4, opacity: 0 }, 0.4);
  }
...
class ImageTrailVariant2 {
  ...
  private showNextImage() {
    ...
    gsap
      ...
      .fromTo(filename, { opacity: 0 }, { duration: 0.4, opacity: 1 }, 0)
      .to(filename, { duration: 0.4, opacity: 0 }, 0.45);
  }
...
class ImageTrailVariant3 {
  ...
  private showNextImage() {
    ...
    gsap
      ...
      .fromTo(filename, { opacity: 0 }, { duration: 0.4, opacity: 1 }, 0)
      .to(filename, { duration: 0.6, opacity: 0 }, 0.6);
  }
...
class ImageTrailVariant5 {
  ...
  private showNextImage() {
    ...
    gsap
      ...
      .fromTo(filename, { opacity: 0 }, { duration: 1, opacity: 1 }, 0)
      .to(filename, { duration: 0.4, opacity: 0 }, 0.5);
  }
...
class ImageTrailVariant6 {
  ...
  private showNextImage() {
    ...
    gsap
      ...
      .fromTo(filename, { opacity: 0 }, { duration: 0.8, opacity: 1 }, 0)
      .to(filename, { duration: 0.4, opacity: 0 }, 0.45);
  }
...
class ImageTrailVariant7 {
  ...
  private showNextImage() {
    ...
    if (this.visibleImagesCount >= this.visibleImagesTotal) {
      ...
      const oldImgFilename = oldImg.DOM.el.querySelector('.filename');
...
class ImageTrailVariant8 {
  ...
  private showNextImage() {
    ...
    gsap
      ...
      .fromTo(filename, { opacity: 0 }, { duration: 1, opacity: 1 }, 0)
      .to(filename, { duration: 0.4, opacity: 0 }, 0.3);
  }
      ...
      {items.map((url, i) => (
        <div className="content__img" key={i}>
          <div className="content__img-inner" style={{ backgroundImage: `url(${url})` }}>
            <span className="filename">{url.split('/').pop()?.split('.').slice(0, -1).join('.')}</span>
          </div>
        </div>
      ))}
    </div>
